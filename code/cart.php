...
<head>
  ...
  <style>
    body{
  background:url("image/image5.jpg") center center/cover no-repeat;
}
  </style>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar navbar-dark" style="background-color:#420606;">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="cart123.php"><i class="fas fa-th-list mr-2"></i>Categories</a>
        </li>
        <li class="nav-item">
  ...
  <div class="container" style="background-color:white;  margin:auto; margin-top:5%
    ">
...
unset($_SESSION['showAlert']); ?></strong>
        ...
        <div class="table-responsive mt-3">
          <table class="table table-bordered table-striped text-center">
            <thead>
              <tr>
                <td colspan="5" class="column-6 footable-last-column">
                  <h4 class="text-center text-info m-3 " style="font-family: 'Dela Gothic One', cursive;">Products in your cart!</h4>
                </td>
              </tr>
              <tr>
                <th>ID</th>
